...
class SeancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seance" do
    assert_difference('Seance.count') do
      post seances_url, params: { seance: { film_id: @seance.film_id, hall_id: @seance.hall_id, time: @seance.time } }
    end
  ...
  test "should update seance" do
    patch seance_url(@seance), params: { seance: { film_id: @seance.film_id, hall_id: @seance.hall_id, time: @seance.time } }
